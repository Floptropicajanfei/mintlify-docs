...
<Steps>
  ...
  <Step title="Moving Files to the correct places">
    After inserting Chronos into your game, place the corresponding files in the correct areas.\\

    Take out `ChronosBoards` from AriProducts Chronos and place it inside Workspace, do not remove anything inside `ChronosBoards`\
